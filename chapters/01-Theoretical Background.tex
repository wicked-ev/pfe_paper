...
\end{itemize}
 ...
 \begin{figure}[H]
 	\centering
 	% Scaled to fit perfectly within standard page margins
 	\includegraphics[width=\textwidth]{figures/2ST.png} 
 	\caption{(a) Two-stage Faster R-CNN with an intermediary region proposal generator. (b) One-stage RetinaNet, which consists of a dense detection pipeline.}
 	\label{fig:detection_architectures}
 \end{figure}
...
\end{enumerate}
 ...
 \begin{figure}[H]
 	...
 	\includegraphics[width=\textwidth]{figures/convolutional-neural-networks-cnns.png} 
